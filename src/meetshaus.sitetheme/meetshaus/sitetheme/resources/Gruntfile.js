        ...
        less: {
            compileTheme: {
                options: {
                    ...
                    sourceMapURL: '<%= config.dist %>/styles/<%= pkg.name %>.css.map',
                    sourceMapFilename: '<%= config.dist %>/styles/<%= pkg.name %>.css.map'
                },
        ...
        criticalcss: {
            frontpage: {
                options: {
                    ...
                    width: 1200,
                    height: 900,
                    outputfile: '<%= config.dist %>/styles/critical.css',
